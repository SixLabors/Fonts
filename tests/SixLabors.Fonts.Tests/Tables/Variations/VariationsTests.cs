...
public class VariationsTests
{
    ...
    public void CanLoadVariationTables_RobotoFlex()
    {
        ...
        Assert.Equal(KnownVariationAxes.Weight, variationAxes.Span[0].Tag);
        ...
        Assert.Equal(KnownVariationAxes.Width, variationAxes.Span[1].Tag);
        ...
        Assert.Equal(KnownVariationAxes.OpticalSize, variationAxes.Span[2].Tag);
        ...
        Assert.Equal(Tag.Parse("GRAD"), variationAxes.Span[3].Tag);
        ...
        Assert.Equal(KnownVariationAxes.Slant, variationAxes.Span[4].Tag);
        ...
        Assert.Equal(Tag.Parse("XTRA"), variationAxes.Span[5].Tag);
        ...
        Assert.Equal(Tag.Parse("XOPQ"), variationAxes.Span[6].Tag);
        ...
        Assert.Equal(Tag.Parse("YOPQ"), variationAxes.Span[7].Tag);
        ...
        Assert.Equal(Tag.Parse("YTLC"), variationAxes.Span[8].Tag);
        ...
        Assert.Equal(Tag.Parse("YTUC"), variationAxes.Span[9].Tag);
        ...
        Assert.Equal(Tag.Parse("YTAS"), variationAxes.Span[10].Tag);
        ...
        Assert.Equal(Tag.Parse("YTDE"), variationAxes.Span[11].Tag);
        ...
        Assert.Equal(Tag.Parse("YTFI"), variationAxes.Span[12].Tag);
    ...
    public void CanLoadVariationTables_AdobeVFPrototype()
    {
        ...
        Assert.Equal(Tag.Parse("CNTR"), variationAxes.Span[1].Tag);
