...
namespace SixLabors.Fonts.Tests.Issues
{
    public class Issues_35
    {
        ...
        public void RenderingTabAtStartOrLineTooShort()
        {
            ...
            FontRectangle tabWithXWidth = TextMeasurer.MeasureBounds("\tx", new TextOptions(font, font.FontMetrics.ScaleFactor));
        ...
        public void TwoTabsAreDoubleWidthOfOneTab()
        {
            ...
            FontRectangle xWidth = TextMeasurer.MeasureBounds("x", new TextOptions(font, font.FontMetrics.ScaleFactor));
            FontRectangle tabWidth = TextMeasurer.MeasureBounds("\t", new TextOptions(font, font.FontMetrics.ScaleFactor));
            FontRectangle twoTabWidth = TextMeasurer.MeasureBounds("\t\t", new TextOptions(font, font.FontMetrics.ScaleFactor));
        ...
        public void TwoTabsAreDoubleWidthOfOneTabMinusXWidth()
        {
            ...
            FontRectangle twoTabWidth = TextMeasurer.MeasureBounds("\t\tx", new TextOptions(font, font.FontMetrics.ScaleFactor));
