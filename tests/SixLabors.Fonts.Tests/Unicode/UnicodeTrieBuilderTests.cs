...
public class UnicodeTrieBuilderTests
{
    ...
    {
        yield return [TestRanges1, CheckValues1];
        yield return [TestRanges2, CheckValues2];
        yield return [TestRanges3, CheckValues3];
        yield return [TestRanges4, CheckValues4];
        yield return [TestRanges5, CheckValues5];
    }
