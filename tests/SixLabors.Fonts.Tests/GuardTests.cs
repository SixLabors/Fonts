...
namespace SixLabors.Shapes.Tests
{
    public class GuardTests
    {
        ...
        {
            SixLabors.Fonts.Utilities.Guard.NotNull("test", "myParamName");
        }
        ...
        public void NotNull_TargetNull_ThrowsException()
        {
            ...
            {
                SixLabors.Fonts.Utilities.Guard.NotNull((object)null, "myParamName");
            });
        }
        ...
        public void NotNull_TargetNullWithMessage_ThrowsException()
        {
            ...
            {
                SixLabors.Fonts.Utilities.Guard.NotNull((object)null, "myParamName", "myTestMessage");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty("test", "myParamName");
        }
        ...
        public void NotNullOrEmpty_TargetNull_ThrowsException()
        {
            Assert.Throws<ArgumentNullException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(null, "myParamName");
            });
        }
        ...
        public void NotNullOrEmpty_TargetWhitespace_ThrowsException()
        {
            ...
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty("\n\n", "myParamName");
            });
        }
        ...
        public void NotNullOrEmpty_TargetEmpty_ThrowsException()
        {
            ...
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(string.Empty, "myParamName");
            });
        ...
        public void NotNullOrEmpty_TargetEmptyWithMessage_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(string.Empty, "myParamName", "myTestMessage");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(new string[] { "test" }, "myParamName");
        }
        ...
        public void NotNullOrEmptyIEnumerable_TargetNull_ThrowsException()
        {
            Assert.Throws<ArgumentNullException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty((IEnumerable<string>)null, "myParamName");
            });
        }
        ...
        public void NotNullOrEmptyIEnumerable_TargetEmpty_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(new string[] { }, "myParamName");
            });
        ...
        public void NotNullOrEmptyIEnumerable_TargetEmptyWithMessage_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.NotNullOrEmpty(new string[] { }, "myParamName", "myTestMessage");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeLessThan(0, 1, "myParamName");
        }
        ...
        public void MustBeLessThan_IsGreaterOrEqual_ThrowsNoException(int value, int max)
        {
            ...
            {
                SixLabors.Fonts.Utilities.Guard.MustBeLessThan(value, max, "myParamName");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeLessThanOrEqualTo(value, max, "myParamName");
        }
        ...
        public void MustBeLessThanOrEqualTo_IsGreater_ThrowsNoException()
        {
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.MustBeLessThanOrEqualTo(2, 1, "myParamName");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeGreaterThan(2, 1, "myParamName");
        }
        ...
        public void MustBeGreaterThan_IsLessOrEqual_ThrowsNoException(int value, int min)
        {
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.MustBeGreaterThan(value, min, "myParamName");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeGreaterThanOrEqualTo(value, min, "myParamName");
        }
        ...
        public void MustBeGreaterThanOrEqualTo_IsLess_ThrowsNoException()
        {
            var exception = Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.MustBeGreaterThanOrEqualTo(1, 2, "myParamName");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeBetweenOrEqualTo(value, min, max, "myParamName");
        }
        ...
        {
            SixLabors.Fonts.Utilities.Guard.IsTrue(true, "myParamName", "myTestMessage");
        }
        ...
        public void IsTrue_IsFalse_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.IsTrue(false, "myParamName", "myTestMessage");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.IsFalse(false, "myParamName", "myTestMessage");
        }
        ...
        public void IsFalse_IsTrue_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.IsFalse(true, "myParamName", "myTestMessage");
            });
        ...
        {
            SixLabors.Fonts.Utilities.Guard.MustBeSizedAtLeast<int>(new int[valueLength], minLength, "myParamName");
        }
        ...
        public void MustBeSizedAtLeast_Array_LengthIsLess_ThrowsException()
        {
            var exception = Assert.Throws<ArgumentException>(() =>
            {
                SixLabors.Fonts.Utilities.Guard.MustBeSizedAtLeast<int>(new int[] { 1, 2 }, 3, "myParamName");
            });
