...
namespace SixLabors.Fonts.Hinting
{
    ...
    internal class Interpreter
    {
            ...
            while (!stream.Done)
            {
                ...
                switch (opcode)
                {
                    ...
                    case OpCode.MSIRP1:
                    {
                        ...
                        if (zp1.IsTwilight)
                        {
                            zp1.Original.ControlPoints[pointIndex] = zp0.Original.ControlPoints[state.Rp0] + targetDistance * state.Freedom / fdotp;
        ...
        private float ReadCvt() => controlValueTable[CheckIndex(stack.Pop(), controlValueTable.Length)];
        ...
        private struct Zone
        {
            ...
            public Vector2 GetCurrent(int index) => Current.ControlPoints[index];
            public Vector2 GetOriginal(int index) => Original.ControlPoints[index];
        }
