...
internal sealed class UnicodeScriptTagMap : Dictionary<ScriptClass, Tag[]>
{
    ...
    private static UnicodeScriptTagMap CreateMap()
        => new()
        {
            ...
            { ScriptClass.Bengali, [Tag.Parse("bng3"), Tag.Parse("bng2"), Tag.Parse("beng")] },
            ...
            { ScriptClass.Default, [Tag.Parse("DFLT"), Tag.Parse("dflt"), Tag.Parse("latn")] },
            { ScriptClass.Devanagari, [Tag.Parse("dev3"), Tag.Parse("dev2"), Tag.Parse("deva")] },
            ...
            { ScriptClass.Gujarati, [Tag.Parse("gjr3"), Tag.Parse("gjr2"), Tag.Parse("gujr")] },
            { ScriptClass.Gurmukhi, [Tag.Parse("gur3"), Tag.Parse("gur2"), Tag.Parse("guru")] },
            ...
            { ScriptClass.Kannada, [Tag.Parse("knd3"), Tag.Parse("knd2"), Tag.Parse("knda")] },
            { ScriptClass.Kaithi, [Tag.Parse("kthi")] },
            { ScriptClass.TaiTham, [Tag.Parse("lana")] },
            { ScriptClass.Lao, [Tag.Parse("lao ")] },
            ...
            { ScriptClass.Malayalam, [Tag.Parse("mlm3"), Tag.Parse("mlm2"), Tag.Parse("mlym")] },
            ...
            { ScriptClass.MyanmarZawgyi, [Tag.Parse("qaag")] },
            ...
            { ScriptClass.Oriya, [Tag.Parse("ory3"), Tag.Parse("ory2"), Tag.Parse("orya")] },
            ...
            { ScriptClass.Tamil, [Tag.Parse("tml3"), Tag.Parse("tml2"), Tag.Parse("taml")] },
            { ScriptClass.Tangut, [Tag.Parse("tang")] },
            { ScriptClass.TaiViet, [Tag.Parse("tavt")] },
            { ScriptClass.Telugu, [Tag.Parse("tel3"), Tag.Parse("tel2"), Tag.Parse("telu")] },
            ...
            { ScriptClass.BeriaErfe, [Tag.Parse("berf")] },
            { ScriptClass.Garay, [Tag.Parse("gara")] },
            { ScriptClass.GurungKhema, [Tag.Parse("gukh")] },
            { ScriptClass.Kawi, [Tag.Parse("kawi")] },
            { ScriptClass.KiratRai, [Tag.Parse("krai")] },
            { ScriptClass.NagMundari, [Tag.Parse("nagm")] },
            { ScriptClass.OlOnal, [Tag.Parse("onao")] },
            { ScriptClass.Sidetic, [Tag.Parse("sidt")] },
            { ScriptClass.Sunuwar, [Tag.Parse("sunu")] },
            { ScriptClass.TaiYo, [Tag.Parse("tayo")] },
            { ScriptClass.Todhri, [Tag.Parse("todr")] },
            { ScriptClass.TolongSiki, [Tag.Parse("tols")] },
            { ScriptClass.TuluTigalari, [Tag.Parse("tutg")] },
        };
}
